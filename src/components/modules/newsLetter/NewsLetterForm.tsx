...
const NewsLetterForm = () => {
  ...
  return (
    <div className="relative shadow-lg overflow-hidden my-10">
      {/* Background image */}
      <div className="absolute inset-0 bg-news-letter bg-cover bg-center z-0" />
      ...
      <div className="relative z-20 text-white py-20 px-4 text-center">
        ...
        >
          <input
            ...
            className="w-full sm:w-96 px-4 py-3 rounded-md text-white focus:outline-none border-2 focus:border-green-500 transition-colors"
            required
          />
          <button
            type="submit"
