...
const AllListingsRental = ({
  ...
  return (
    <div>
      ...
      {/* Filters & Listings */}
      <div className="container mx-auto px-3 my-10 md:my-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
          <div>
            <h2 className="text-xl font-bold">Your Next Favorite House Awaits</h2>
            <p className="text-gray-500">Showing approx 6 available listings for you...</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {allAmenitiesList?.map((amenity) => (
                <label
                  key={amenity}
                  className="flex items-center gap-2 cursor-pointer select-none space-y-1"
                >
                  <input
                    type="checkbox"
