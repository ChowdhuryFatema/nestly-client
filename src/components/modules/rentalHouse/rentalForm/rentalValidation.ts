...
export const rentalSchema = z.object({
    ...
    rentAmount: z.number({ required_error: "Rent is required" }).min(1, { message: "Rent is required" }),
    bedrooms: z.number({ required_error: "Number of Bedrooms is required" }).min(1, { message: "Number of Bedrooms is required" }),
